...
?>
	...
	<meta property="og:image" content="<?php if ( $thumb == false ) { echo $default_img; } else { echo $thumb; } ?>" />
<?php  } else { ?>
	<meta property="og:type" content="article" />
...
<p>Default Thumbnail URL <input type="text" name="s4defthumb" style="width: 300px;" value="<?php echo get_option('s4defthumb',''); ?>" /></p>
